...
public class UserData extends AppCompatActivity {
               TextView  fullname,cours,email,phone;
               ImageView image;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference userRef = rootRef.child("teachers");

        setContentView(R.layout.activity_user_data);

        fullname=(TextView)findViewById(R.id.Fullname);
        cours=(TextView) findViewById(R.id.occupation_textview);
        ...
        userRef.addValueEventListener(new ValueEventListener() {
            String name1, email1, cours1;
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot keyId: dataSnapshot.getChildren()) {

                        name1 = keyId.child("name").getValue(String.class);
                        cours1 = keyId.child("course").getValue(String.class);
                        email1 = keyId.child("email").getValue(String.class);
